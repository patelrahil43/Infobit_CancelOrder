...
class InstallSchema implements InstallSchemaInterface {
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context) {
        ...
        $table = $setup->getConnection()
                ->newTable($setup->getTable('infobit_cancelorder_question'))
                ->addColumn(
        ...
        $table = $setup->getConnection()
                ...
                ->addColumn(
                        'question_id', \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false], 'Item Count'
                )
                ->addColumn(
                ...
                ->addForeignKey(
                        $setup->getFkName('infobit_cancelorder_request', 'question_id', 'sales_order', 'entity_id'), 'question_id', $setup->getTable('infobit_cancelorder_question'), 'entity_id', \Magento\Framework\DB\Ddl\Table::ACTION_CASCADE
                )
